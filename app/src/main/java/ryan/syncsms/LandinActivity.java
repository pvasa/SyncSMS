...
import ryan.syncsms.fragments.IntroOneFragment;
import ryan.syncsms.fragments.PermissionFragment;

/**
 * An example full-screen activity that shows and hides the system UI (i.e.
 * status bar and navigation/system bar) with user interaction.
 */
public class LandinActivity extends AppIntro2 {
    /**
...
//        addSlide(AppIntroFragment.newInstance("Generate & Fix", "Generate a ticket to fix the issue", R.drawable.ic_fixing, getResources().getColor(R.color.darkBlueGrey)));
        ...
        addSlide(new PermissionFragment());
